...
class Log extends Common{
	...
	public function __destruct(){
		...
		if($this->debug===TRUE){
			...
			echo $this->log("Ambiente de execução: ". debug::getEnvironment('host') . " - " . debug::getEnvironment('os') . " - " . debug::getEnvironment('release') . " - " . debug::getEnvironment('version') . " - " . debug::getEnvironment('machine') . "\r\n");
