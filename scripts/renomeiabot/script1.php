...
{{Respondido2|negado|texto=";
      ...
      $newrequest[$control] = str_replace($out[0],$header,$newrequest[$control]);
      $newrequest[$control] = $newrequest[$control] . "
::{{subst:negado|Negado automaticamente}} {{ping|" . $actualname . "}} Olá! O nome de usuário que você escolheu (" . $newname . ") já está em uso. Se " . $newname . " não possui edições ([[Especial:Administração de contas globais/" . $newname . "|verifique aqui]]), ele pode ser elegível para usurpação (se for o caso, solicite [[m:Special:MyLanguage/USURP|nesta página]]). No entanto, na maioria das vezes o mais recomendado é escolher outro nome que não conste [[Especial:Administração de contas globais|nesta lista]] e abrir um novo pedido. Obrigado! ~~~~}}";
